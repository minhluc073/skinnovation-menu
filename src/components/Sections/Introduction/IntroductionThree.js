              ...
              <div className="introduction-three__image__detail">
                <div className="image__item">
                  <div ref={bg1} className="wrapper">
                    <img
                      data-depth="0.3"
                      src="/shop/assets/images/introduction/IntroductionThree/img-1.png"
                      alt="image"
                    />
                  </div>
                </div>
                <div className="image__item">
                  <div ref={bg2} className="wrapper">
                    <img
                      ...
                      data-invert-x
                      data-invert-y
                      src="/shop/assets/images/introduction/IntroductionThree/img-2.png"
                      alt="image"
                    />
                  </div>
                </div>
              ...
              <div className="more-description">
                <img
                  src={
                    ...
                    "/shop/assets/images/introduction/IntroductionThree/decoration.png"
                  }
                  alt="Decoration"
                />
                <span>
