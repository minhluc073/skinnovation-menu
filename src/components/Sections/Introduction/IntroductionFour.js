                  ...
                  <div className="introduction-four__item__image">
                    <img
                      src={
                        ...
                        "/shop/assets/images/introduction/IntroductionFour/1.png"
                      }
                  ...
                  <div className="introduction-four__item__image">
                    <img
                      src={
                        ...
                        "/shop/assets/images/introduction/IntroductionFour/2.png"
                      }
                      alt="Meet trends of the season"
                    />
                  </div>
                  ...
                  <div className="introduction-four__item__image">
                    <img
                      src={
                        ...
                        "/shop/assets/images/introduction/IntroductionFour/3.png"
                      }
                      alt="Meet trends of the season"
                    />
                  </div>
                  ...
                  <div className="introduction-four__item__image">
                    <img
                      src={
                        ...
                        "/shop/assets/images/introduction/IntroductionFour/4.png"
                      }
                      alt="Meet trends of the season"
                    />
                  </div>
