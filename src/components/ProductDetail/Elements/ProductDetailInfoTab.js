...
export default function ProductDetailInfoTab({ instructions, ingredients, faq, highlights }) {
    ...
    <div className="product-detail__tab">
      <Tabs className="product-detail__tab__content">
        <TabList className="tab__content__header">
          {highlights && <Tab>Highlights</Tab>}
          {instructions && <Tab>Instructions</Tab>}
          {faq && <Tab>FAQ</Tab>}
          {ingredients && <Tab>Ingredients</Tab>}
        </TabList>
        {highlights && (
          <TabPanel className="tab__content__item -description">
            <BlockContent blocks={highlights} />
          </TabPanel>
        )}
        {instructions && (
          <TabPanel className="tab__content__item -description">
            <BlockContent blocks={instructions} />
            {/* <ShippingInfo /> */}
          </TabPanel>
        )}
        {faq && (
          <TabPanel className="tab__content__item -description">
            <BlockContent blocks={faq} />
          </TabPanel>
        )}
         {ingredients && (
          <TabPanel className="tab__content__item -description">
            <BlockContent blocks={ingredients} />
          </TabPanel>
        )}
      </Tabs>
    </div>
...
//     <p>
//       We diliver to over 100 countries around the word. For full details of the
